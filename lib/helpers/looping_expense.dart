...
class LoopingExamples {
  ...
  static double calculateTotalFold() {
   ...
   // FUNGSI BARU: Menghitung total dari daftar yang spesifik
  static double calculateFilteredTotal(List<Expense> expensesToCalculate) {
    if (expensesToCalculate.isEmpty) return 0.0;
    return expensesToCalculate.fold(0.0, (sum, expense) => sum + expense.amount);
  }
